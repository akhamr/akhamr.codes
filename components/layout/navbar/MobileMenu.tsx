            ...
            {({ open }) => (
                <>
                    ...
                    <Transition
                        ...
                        leaveTo="opacity-0"
                    >
                        <Menu.Items className="fixed right-[7.5%] mt-8 mr-4 w-36 space-y-1 p-2 rounded-md bg-stone-100 dark:bg-stone-800 outline-dashed outline-2 outline-offset-4 outline-gray-200 dark:outline-gray-800">
                            {links.map((link, i) => {
                                return (
                                    <Menu.Item key={i}>
                                        <Link
